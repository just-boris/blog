...
Посмотреть на скрипт в действии можно в этом же блоге, так оформлена страница "Мои проекты":

<a class="watch-demo" href="/projects/">Демо страница</a>
...
Например есть версия такой же странице на фреймворке [BasisJS](http://basisjs.com). [Посмотрите](http://catatron.com/repo-list/ru/), стиль написания похож на Backbone. 
